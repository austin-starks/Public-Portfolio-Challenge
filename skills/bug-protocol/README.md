...
```bash
# Claude Code   → ~/skills/bug-protocol
# Codex CLI     → ~/.agents/skills/bug-protocol
# Gemini CLI    → ~/.gemini/skills/bug-protocol
# Cursor (proj) → .cursor/rules/bug-protocol
...
Start a new session and type `/bug-protocol` (or just describe a matching task and it
