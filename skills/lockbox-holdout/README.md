...
```bash
# Claude Code   → ~/skills/lockbox-holdout
# Codex CLI     → ~/.agents/skills/lockbox-holdout
# Gemini CLI    → ~/.gemini/skills/lockbox-holdout
# Cursor (proj) → .cursor/rules/lockbox-holdout
...
Start a new session and type `/lockbox-holdout` (or just describe a matching task and it
