...
7. **Do not mutate** the incumbent Challenge book or the MU+SNDK book (IDs below).
...
| Role | Value |
| --- | --- |
| Live target | `6a5e20a3ea0d6db55c69a171` — Public Portfolio (`5OH86568`), Public brokerage, `initialValue` 5500, certified at cash **$5,494.51** |
...
1. **Do not mutate KEEP, the live target’s cloned rules, the incumbent, or MU+SNDK.**
